...
fn bench_row_multiply(c: &mut Criterion) {
    ...
    for &size in &sizes {
        ...
        group.bench_with_input(
            BenchmarkId::new("fine_level", size), 
            &size,
            |bench, _| bench.iter(|| {
                let (cols, vals) = multiply_row_fine_level(
                    0, 
                    &a_medium, 
                    &b, 
                    &config
        ...
        group.bench_with_input(
            BenchmarkId::new("coarse_level", size), 
            &size,
            |bench, _| bench.iter(|| {
                let (cols, vals) = multiply_row_coarse_level(
                    0, 
                    &a_dense, 
                    &b, 
                    &config
...
fn bench_matrix_multiply(c: &mut Criterion) {
    ...
    for &size in &sizes {
        for &density in &densities {
            ...
            group.bench_with_input(
                BenchmarkId::new(format!("reference_{}_{}", size, (density * 100.0) as u32), size), 
                &size,
                |bench, _| {
                    bench.iter(|| {
            ...
            group.bench_with_input(
                BenchmarkId::new(format!("magnus_{}_{}", size, (density * 100.0) as u32), size), 
                &size,
                |bench, _| {
                    bench.iter(|| {
            ...
            group.bench_with_input(
                BenchmarkId::new(format!("magnus_parallel_{}_{}", size, (density * 100.0) as u32), size), 
                &size,
                |bench, _| {
                    bench.iter(|| {
