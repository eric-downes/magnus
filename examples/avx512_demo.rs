...
use magnus::accumulator::{Accumulator, avx512::Avx512Accumulator, sort::SortAccumulator};
...
fn main() {
    ...
    println!("AVX512 available: {}", magnus::accumulator::avx512::is_avx512_available());
    println!("AVX512CD available: {}\n", magnus::accumulator::avx512::is_avx512cd_available());
    ...
    for &size in &sizes {
        ...
        println!("Size {:4}: AVX512: {:8.3}ms, Generic: {:8.3}ms, Speedup: {:.2}x",
            size,
