...
use magnus::accumulator::avx512::Avx512Accumulator;
use magnus::accumulator::{sort::SortAccumulator, Accumulator};
...
fn main() {
    ...
    {
        println!("AVX512 is not available on this architecture.");
        println!("This demo requires x86_64 architecture with AVX512 support.");
    }
}
