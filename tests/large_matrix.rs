...
fn generate_power_law_matrix(n: usize, avg_degree: usize, seed: u64) -> SparseMatrixCSR<f64> {
    let mut rng = ChaCha8Rng::seed_from_u64(seed);
...
fn test_large_matrix_correctness_1m() {
    ...
    println!(
        ...
        a.n_rows, a.n_cols, nnz_a
    );
    println!(
        "Matrix B: {} x {} with {} non-zeros",
        b.n_rows, b.n_cols, nnz_b
    );
...
fn test_power_law_matrix_5m() {
    ...
    let nnz_b = b.col_idx.len();
    println!(
        "Power-law A: {} x {} with {} non-zeros",
        a.n_rows, a.n_cols, nnz_a
    );
    println!(
        "Power-law B: {} x {} with {} non-zeros",
        b.n_rows, b.n_cols, nnz_b
    );
...
fn test_ultra_sparse_10m() {
    ...
    println!(
        "Ultra-sparse matrix: {} x {} with {} non-zeros",
