...
use magnus::{
    magnus_spgemm, magnus_spgemm_parallel, process_coarse_level_rows_parallel, reference_spgemm,
...
fn test_parallel_large_random_matrices() {
    ...
    let a = SparseMatrixCSR::new(n, n, row_ptr_a, col_idx_a, values_a);
    ...
    let b = SparseMatrixCSR::new(n, n, row_ptr_b, col_idx_b, values_b);
